...
class FixedPerMonth extends BillingDeterminants {
    ...
    calculate() {
        return times(MONTHS_PER_YEAR$1, () => 1);
    }
}
...
class PriceProfile {
    ...
    max() {
        ...
        return (_b = (_a = maxBy(this.expanded(), 'price')) === null || _a === undefined ? undefined : _a.price) !== null && _b !== undefined ? _b : 0;
    }
...
class LoadProfile {
    ...
    max() {
        ...
        // lodash's maxBy interface returns T | undefined so we need the ?? 0 here although it should never be 0
        return (_b = (_a = maxBy(this.expanded(), 'load')) === null || _a === undefined ? undefined : _a.load) !== null && _b !== undefined ? _b : 0;
    }
    loadFactor() {
        if (this.count() === 0) {
            return 0;
