    ...
    formatCharge() {
        switch (this._classification) {
            case RateElementClassification.ENERGY: {
                return lodashExports.mean(this.charge).toFixed(5);
            }
            default: {
                return lodashExports.mean(this.charge).toFixed(2);
            }
        }
    }
}
...
export { BillingCategory, BillingDeterminantsUnits, ERateElementType, LoadProfile, RATE_ELEMENT_CLASSIFICATION_BY_RATE_ELEMENT_TYPE, RATE_ELEMENT_SORT_ORDER, RateCalculator, RateComponent, RateElement, RateElementClassification, RateEngineVersion };
