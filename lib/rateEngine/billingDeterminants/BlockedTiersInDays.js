...
var BlockedTiersInDays = /** @class */ (function (_super) {
    __extends(BlockedTiersInDays, _super);
    function BlockedTiersInDays(_a, loadProfile) {
        var _this = this;
    ...
    BlockedTiersInDays.prototype.filteredLoadProfile = function () {
        return this._loadProfile.filterBy(this._filters);
    };
    BlockedTiersInDays.prototype.calculate = function () {
        var _this = this;
        var mins = (0, assumptions_1.daysPerMonth)(this._loadProfile.year).map(function (days, i) { return days * _this._min[i]; });
        var maxes = (0, assumptions_1.daysPerMonth)(this._loadProfile.year).map(function (days, i) { return days * _this._max[i]; });
