...
var DemandTimeOfUse_1 = __importDefault(require("../DemandTimeOfUse"));
var DemandTimeOfUseData_1 = __importDefault(require("./DemandTimeOfUseData"));
var getLoadProfileOfOnes = function () { return (0, times_1.default)(8760, function () { return 1; }); };
var onesByMonth = (0, times_1.default)(12, function () { return 1; });
var zerosByMonth = (0, times_1.default)(12, function () { return 0; });
describe('DemandTimeOfUse', function () {
    var loadProfile;
    beforeEach(function () {
    ...
    describe('calculate', function () {
        it('calculates energy time of use with nothing filtered', function () {
            var result = new DemandTimeOfUse_1.default({
                months: [],
                daysOfWeek: [],
                hourStarts: [],
                onlyOnDays: [],
        ...
        DemandTimeOfUseData_1.default.forEach(function (_a) {
            ...
            it("calculates energy time of use for ".concat(name, " filters"), function () {
                var result = new DemandTimeOfUse_1.default(filters, inputLoadProfile).calculate();
