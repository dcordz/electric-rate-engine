...
var MonthlyEnergy = /** @class */ (function (_super) {
    __extends(MonthlyEnergy, _super);
    function MonthlyEnergy(loadProfile) {
        var _this = _super.call(this) || this;
        _this.rateElementType = 'Monthly Energy';
    ...
    MonthlyEnergy.prototype.calculate = function () {
        return this._loadProfile.sumByMonth();
    };
    return MonthlyEnergy;
}(_BillingDeterminants_1.default));
exports.default = MonthlyEnergy;
