...
// 1. Load profile with _no_ filters, check that it matches hours / month
// 2. Load profile with everything filtered, check that it's all zeros
// 3. Load profile from spreadsheet, check that it matches with filters
